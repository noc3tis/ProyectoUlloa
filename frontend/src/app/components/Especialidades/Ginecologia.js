...
const Ginecologia = () => { // <--- 1. CAMBIAR NOMBRE DEL COMPONENTE (Ej: Dermatologia)
  ...
  const medicosFiltrados = medicos.filter(medico => 
      medico.especialidad === 'Ginecologia' // <--- 2. CAMBIAR AQUÍ LA ESPECIALIDAD
  );
...
export default Ginecologia; // <--- 4. EXPORTAR CON EL NOMBRE CORRECTO